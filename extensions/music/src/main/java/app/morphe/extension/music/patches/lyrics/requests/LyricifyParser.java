...
final class LyricifyParser {
    ...
    private static final String TAG = "LyricifyParser";
    ...
    static List<LyricsLine> parseLines(String text, int offsetMs) {
        ...
        if (lines.isEmpty()) {
            Log.w(TAG, "parseLines: no lines parsed (" + text.length() + " chars)");
            return Collections.emptyList();
        }
    ...
    static List<LyricsLine> parseSyllable(String text, int offsetMs) {
        ...
        if (lines.isEmpty()) {
            Log.w(TAG, "parseSyllable: no lines parsed (" + text.length() + " chars)");
            return Collections.emptyList();
        }
