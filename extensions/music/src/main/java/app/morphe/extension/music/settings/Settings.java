...
public class Settings extends SharedYouTubeSettings {
    ...
    public static final BooleanSetting LYRICS_USE_POLLINATIONS = new BooleanSetting("morphe_music_lyrics_use_pollinations", FALSE, true, parent(LYRICS_SHOW_TRANSLATE_BUTTON));
